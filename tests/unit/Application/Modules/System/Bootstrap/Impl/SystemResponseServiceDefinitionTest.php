...
namespace Tests\Unit\Application\Modules\System\Bootstrap\Impl;

use PHPUnit\Framework\TestCase;
use App\Application\Modules\System\Bootstrap\Impl\SystemResponseServiceDefinition;
use App\Application\Shared\ServiceDefinitionInterface;
use DI\ContainerBuilder;

final class SystemResponseServiceDefinitionTest extends TestCase
{
    private SystemResponseServiceDefinition $serviceDefinition;

    protected function setUp(): void
    {
        $this->serviceDefinition = new SystemResponseServiceDefinition();
    }
    ...
    public function testRegisterIncludesSystemResponseServiceInterface(): void
    {
        $builder = $this->createMock(ContainerBuilder::class);
        $capturedDefinitions = null;
        ...
        $this->assertArrayHasKey('App\Domain\System\Services\SystemResponseServiceInterface', $capturedDefinitions);
    }
    ...
    {
        $definition = new SystemResponseServiceDefinition();

        $this->assertInstanceOf(SystemResponseServiceDefinition::class, $definition);
