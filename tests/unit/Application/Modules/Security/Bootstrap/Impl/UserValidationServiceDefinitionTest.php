...
use App\Application\Modules\Security\Bootstrap\Impl\UserValidationServiceDefinition;
use App\Application\Shared\ServiceDefinitionInterface;
use DI\ContainerBuilder;

final class UserValidationServiceDefinitionTest extends TestCase
{
    private UserValidationServiceDefinition $serviceDefinition;

    protected function setUp(): void
    {
        $this->serviceDefinition = new UserValidationServiceDefinition();
    }
    ...
    public function testRegisterIncludesUserValidationServiceInterface(): void
    {
        $builder = $this->createMock(ContainerBuilder::class);
        $capturedDefinitions = null;
        ...
        $this->assertArrayHasKey('App\Domain\Security\Services\UserValidationServiceInterface', $capturedDefinitions);
    }
    ...
    {
        $definition = new UserValidationServiceDefinition();

        $this->assertInstanceOf(UserValidationServiceDefinition::class, $definition);
