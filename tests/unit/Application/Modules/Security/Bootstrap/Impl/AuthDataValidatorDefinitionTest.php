...
final class AuthDataValidatorDefinitionTest extends TestCase
{
    private AuthDataValidatorDefinition $serviceDefinition;

    protected function setUp(): void
    {
        $this->serviceDefinition = new AuthDataValidatorDefinition();
    }
    ...
    public function testRegisterIncludesAuthDataValidatorInterface(): void
    {
        $builder = $this->createMock(ContainerBuilder::class);
        $capturedDefinitions = null;
        ...
        $this->assertArrayHasKey('App\Domain\Security\Validators\AuthDataValidatorInterface', $capturedDefinitions);
    }
    ...
    {
        $definition = new AuthDataValidatorDefinition();

        $this->assertInstanceOf(AuthDataValidatorDefinition::class, $definition);
