...
namespace App\Application\Modules\Auth\Http\Routing;
...
final class AuthRouteProvider implements RouteProviderInterface
{
    ...
    public function hasPriorityOver(RouteProviderInterface $other): bool
    {
        ...
        if ($other instanceof \App\Application\Shared\Http\Routing\CoreRouteProvider) {
            return false; // Core (10) tem prioridade maior
        }
        if ($other instanceof \App\Application\Modules\System\Http\Routing\SystemRouteProvider) {
