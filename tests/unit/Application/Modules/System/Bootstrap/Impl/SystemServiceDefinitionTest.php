...
use App\Application\Modules\System\Bootstrap\Impl\SystemServiceDefinition;
use App\Application\Shared\ServiceDefinitionInterface;
use DI\ContainerBuilder;

final class SystemServiceDefinitionTest extends TestCase
{
    private SystemServiceDefinition $serviceDefinition;

    protected function setUp(): void
    {
        $this->serviceDefinition = new SystemServiceDefinition();
    }
    ...
    public function testRegisterIncludesSystemServiceInterface(): void
    {
        $builder = $this->createMock(ContainerBuilder::class);
        $capturedDefinitions = null;
        ...
        $this->assertArrayHasKey('App\Domain\System\Services\SystemServiceInterface', $capturedDefinitions);
    }
    ...
    {
        $definition = new SystemServiceDefinition();

        $this->assertInstanceOf(SystemServiceDefinition::class, $definition);
