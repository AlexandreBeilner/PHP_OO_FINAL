...
use App\Application\Shared\Impl\EntityPathServiceDefinition;
use App\Application\Shared\ServiceDefinitionInterface;
use DI\ContainerBuilder;

final class EntityPathServiceDefinitionTest extends TestCase
{
    private EntityPathServiceDefinition $serviceDefinition;

    protected function setUp(): void
    {
        $this->serviceDefinition = new EntityPathServiceDefinition();
    }
    ...
    public function testRegisterIncludesEntityPathCollectorInterface(): void
    {
        $builder = $this->createMock(ContainerBuilder::class);
        $capturedDefinitions = null;
        ...
        $this->assertArrayHasKey('App\Application\Shared\EntityPaths\EntityPathCollectorInterface', $capturedDefinitions);
    }
    ...
    {
        $definition = new EntityPathServiceDefinition();

        $this->assertInstanceOf(EntityPathServiceDefinition::class, $definition);
