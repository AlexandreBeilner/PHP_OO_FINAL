...
use App\Application\Shared\Impl\RouteProviderFactoryDefinition;
use App\Application\Shared\ServiceDefinitionInterface;
use DI\ContainerBuilder;

final class RouteProviderFactoryDefinitionTest extends TestCase
{
    private RouteProviderFactoryDefinition $serviceDefinition;

    protected function setUp(): void
    {
        $this->serviceDefinition = new RouteProviderFactoryDefinition();
    }
    ...
    public function testRegisterIncludesRouteProviderFactoryInterface(): void
    {
        $builder = $this->createMock(ContainerBuilder::class);
        $capturedDefinitions = null;
        ...
        $this->assertArrayHasKey('App\Application\Shared\Http\Routing\RouteProviderFactoryInterface', $capturedDefinitions);
    }
    ...
    public function testRegisterDefinitionContainsDefinition(): void
    {
        $builder = $this->createMock(ContainerBuilder::class);
        $capturedDefinitions = null;
        ...
        // Each definition should be a DI definition object
    ...
    {
        $definition = new RouteProviderFactoryDefinition();

        $this->assertInstanceOf(RouteProviderFactoryDefinition::class, $definition);
