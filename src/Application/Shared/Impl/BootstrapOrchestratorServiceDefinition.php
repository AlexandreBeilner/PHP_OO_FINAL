    ...
    public function register(ContainerBuilder $builder): void
    {
        $builder->addDefinitions([
            ...
            BootstrapOrchestratorInterface::class => function ($container): BootstrapOrchestratorInterface {
                ...
                // CRÍTICO: Inicializar bootstraps no orchestrator do container
                // Sem isso, o orchestrator fica com registry vazio e collectAllEntityPaths() retorna []
                // causando erro "paths required when using AnnotationDriver" no Doctrine
