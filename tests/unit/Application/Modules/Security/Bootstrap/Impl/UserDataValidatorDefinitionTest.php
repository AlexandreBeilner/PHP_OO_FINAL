...
use App\Application\Modules\Security\Bootstrap\Impl\UserDataValidatorDefinition;
use App\Application\Shared\ServiceDefinitionInterface;
use DI\ContainerBuilder;

final class UserDataValidatorDefinitionTest extends TestCase
{
    private UserDataValidatorDefinition $serviceDefinition;

    protected function setUp(): void
    {
        $this->serviceDefinition = new UserDataValidatorDefinition();
    }
    ...
    public function testRegisterIncludesUserDataValidatorInterface(): void
    {
        $builder = $this->createMock(ContainerBuilder::class);
        $capturedDefinitions = null;
        ...
        $this->assertArrayHasKey('App\Domain\Security\Validators\UserDataValidatorInterface', $capturedDefinitions);
    }
    ...
    {
        $definition = new UserDataValidatorDefinition();

        $this->assertInstanceOf(UserDataValidatorDefinition::class, $definition);
