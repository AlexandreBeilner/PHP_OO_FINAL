...
use Tests\Integration\AbstractBaseIntegration;
...
final class UserServiceIntegrationTest extends AbstractBaseIntegration
{
    ...
    public function testDeleteUser(): void
    {
        ...
        try {
            ...
            // Verifica que a exceção é do tipo correto e contém informação sobre usuário não encontrado
            $this->assertInstanceOf(\App\Domain\Common\Exceptions\Impl\BusinessLogicExceptionAbstract::class, $e);
            $this->assertStringContainsString('não encontrado', $e->getMessage());
        }
    }
