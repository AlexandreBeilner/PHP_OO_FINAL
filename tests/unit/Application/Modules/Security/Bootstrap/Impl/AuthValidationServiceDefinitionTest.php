...
final class AuthValidationServiceDefinitionTest extends TestCase
{
    private AuthValidationServiceDefinition $serviceDefinition;

    protected function setUp(): void
    {
        $this->serviceDefinition = new AuthValidationServiceDefinition();
    }
    ...
    public function testRegisterIncludesAuthValidationServiceInterface(): void
    {
        $builder = $this->createMock(ContainerBuilder::class);
        $capturedDefinitions = null;
        ...
        $this->assertArrayHasKey('App\Domain\Security\Services\AuthValidationServiceInterface', $capturedDefinitions);
    }
    ...
    {
        $definition = new AuthValidationServiceDefinition();

        $this->assertInstanceOf(AuthValidationServiceDefinition::class, $definition);
